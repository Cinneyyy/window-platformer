...
#pragma warning disable // This doth prevent a rather abnormal behaviour, whereof this function may become marked as 'being used not' (if it be thy will to request more information, thou mayest refer to IDE0051)
